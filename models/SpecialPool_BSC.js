...
// Create Schema
const SpecialPool_BSCSchema = new Schema(
  {
    address: {
      type: String,
      required: true,
...
SpecialPool_BSCSchema.set('toJSON', { getters: true });
SpecialPool_BSCSchema.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  delete obj._id;
  return obj;
};
module.exports = SpecialPool_BSC = mongoose.model("specialpool_bsc", SpecialPool_BSCSchema);
