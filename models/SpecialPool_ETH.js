...
// Create Schema
const SpecialPool_ETHSchema = new Schema(
  {
    address: {
      type: String,
      required: true,
...
SpecialPool_ETHSchema.set('toJSON', { getters: true });
SpecialPool_ETHSchema.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  delete obj._id;
  return obj;
};
module.exports = SpecialPool_ETH = mongoose.model("specialpool_eth", SpecialPool_ETHSchema);
