...
// Create Schema
const Pool_POLYGONSchema = new Schema(
  {
    address: {
      type: String,
      required: true,
...
Pool_POLYGONSchema.set('toJSON', { getters: true });
Pool_POLYGONSchema.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  delete obj._id;
  return obj;
};
module.exports = Pool_POLYGON = mongoose.model("pool_polygon", Pool_POLYGONSchema);
