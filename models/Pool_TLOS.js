...
// Create Schema
const Pool_TLOSSchema = new Schema(
  {
    address: {
      type: String,
      required: true,
...
Pool_TLOSSchema.set('toJSON', { getters: true });
Pool_TLOSSchema.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  delete obj._id;
  return obj;
};
module.exports = Pool_TLOS = mongoose.model("pool_tlos", Pool_TLOSSchema);
