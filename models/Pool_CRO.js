...
// Create Schema
const Pool_CROSchema = new Schema(
  {
    address: {
      type: String,
      required: true,
...
Pool_CROSchema.set('toJSON', { getters: true });
Pool_CROSchema.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  delete obj._id;
  return obj;
};
module.exports = Pool_CRO = mongoose.model("pool_cro", Pool_CROSchema);
